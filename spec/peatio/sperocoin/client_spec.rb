RSpec.describe Peatio::Sperocoin::Client do
  ...
  subject { Peatio::Sperocoin::Client.new(uri) }
    ...
    context :methodnotfound do
      ...
      it do
        expect{ subject.json_rpc(:methodnotfound) }.to \
          raise_error(Peatio::Sperocoin::Client::ResponseError, "Method not found (-32601)")
      end
    end
    ...
    context :notfound do
      ...
      it do
        expect{ subject.json_rpc(:notfound) }.to \
          raise_error(Peatio::Sperocoin::Client::Error)
      end
    end
    ...
    context :connectionerror do
      ...
      it do
        expect{ subject.json_rpc(:connectionerror) }.to \
          raise_error(Peatio::Sperocoin::Client::ConnectionError)
      end
    end
  end
end
