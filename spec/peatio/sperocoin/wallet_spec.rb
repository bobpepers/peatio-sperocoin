RSpec.describe Peatio::Sperocoin::Wallet do
  let(:wallet) { Peatio::Sperocoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Sperocoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Sperocoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
